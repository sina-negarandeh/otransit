...
public enum Feed {
    ...
    /// API does not serve one: only TripUpdates exists. The notices are RSS
    ...
    /// notice is still a board; a board that took ten seconds to appear is not.
    public static func notices() async throws -> Updates {
